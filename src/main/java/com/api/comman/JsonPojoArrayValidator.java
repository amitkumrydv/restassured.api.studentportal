...
public class JsonPojoArrayValidator {
	...
	public <T> void validateJsonWithPojo(String responseBodyData, Class<T> pojoClass) {
	    try {
	        ...
	        for (Map.Entry<String, Object> entry : jsonMap.entrySet()) {
	            ...
	            System.out.println(jsonFieldsEncountered);
	            ...
	            if (!pojoFieldNames.contains(jsonFieldName)) {
	                logger.error("JSON field '{}' is not present in POJO: {}", jsonFieldName, pojoClass.getSimpleName());
	            ...
	            try {
	                ...
	                logger.error("Field '{}' not found in POJO class: {}", jsonFieldName, pojoClass.getSimpleName());
	        ...
	        logger.info("Validation completed successfully for POJO: {}", pojoClass.getSimpleName());
	    } catch (Exception e) {
