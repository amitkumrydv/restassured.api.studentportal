...
public class AuthenticateTest {
	...
	public void authenticateGETHeaderTest() {
		...
		Response response = authenticateEndPointImpl.authenticateResponseForGET();
		Long responseTime = response.getTime();
		try {
	...
	public void authenticateDELETEHeaderTest() {
		...
		Response response = authenticateEndPointImpl.authenticateResponseForDELETE();
		Long responseTime = response.getTime();
		try {
			ApplySeverityLevel.setSeverityForPostUsingAnotherMethod(response.getStatusCode());
			response.then()
	...
	public void authenticateResponseForEmptyPayloadTest() {
		...
		// @formatter:off
		Response response = authenticateEndPointImpl.authenticateResponseForEmptyPayload();
		Long responseTime = response.getTime();
	...
	public void authenticateResponseForInvalidPayloadTest() {
      ...
      try {
		// @formatter:off
		Response response = authenticateEndPointImpl.authenticateResponseForInvalidPayload();
		Long responseTime = response.getTime();
	...
	public void authenticateResponseForMissingFieldsTest() {
      ...
      try {
		// @formatter:off
		Response response = authenticateEndPointImpl.authenticateResponseForMissingFieldsPayload();
		Long responseTime = response.getTime();
