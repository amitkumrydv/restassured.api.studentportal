...
public class GetVideosForHomeTest {
	...
	public void getVideosForHomeGetHeaderTest() {
	    ...
	    Response response = getVideosForHomeEndPointsImpl.getVideosForHomeHeaderGet();
	    Long responseTime = response.getTime();
	...
	public void getVideosForHomeDELETEHeaderTest() {
	    ...
	    Response response = getVideosForHomeEndPointsImpl.getVideosForHomeHeaderDELETE();
	    Long responseTime = response.getTime();
	...
	public void getVideosForHomeEmptyPayloadTest() {
      ...
      try {
    	  Response response = getVideosForHomeEndPointsImpl.getVideosForHomeEmptyPayload();
		Long responseTime = response.getTime();
	...
	public void getVideosForHomeInvalidPayloadTest() {
      ...
      try {
		// @formatter:off
    	  Response response = getVideosForHomeEndPointsImpl.getVideosForHomeInvalidPayload();
		Long responseTime = response.getTime();
	...
	public void getVideosForHomeMissingFieldsTest() {
      ...
      try {
		// @formatter:off
    	  Response response = getVideosForHomeEndPointsImpl.getVideosForHomeMissingFields();
		Long responseTime = response.getTime();
